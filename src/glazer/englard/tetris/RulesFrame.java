	...
	public RulesFrame() {
		...
		JLabel list = new JLabel(
				"<html><p style=\" padding:10;\">To play press the start button<br> "
						...
						+ "To MOVE LEFT hit the left arrow <br><br> Scoring: <br> 1 Line = 40*(level)<br> 2 Lines = 100*(level) <br>3 Lines = 300*(level) <br> 4 Lines = 1200*(level)"
						+ "<br>Clear the board = 2000*(level)"
						+ "<br>Every piece = 10*(level) <br> drop = 2 piont </p></html>");
